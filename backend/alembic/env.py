...
from app.infrastructure.database.session import Base  # noqa
...
# Configurar la conexión a la base de datos desde settings
...
# Añadir el objeto MetaData de tu modelo aquí
